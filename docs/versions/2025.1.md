...
!!! Individual
    ...
    === "Tarefas"
        ...
        |-|-|-:|
        | Checkpoint 1 | CRUD Spring Boot | 10% |
        | Checkpoint 2 | Gateway Spring Cloud | 15% |
        | Checkpoint 3 | Security Spring Cloud | 15% |
        | Checkpoint 4 | DevOps | 20% |
        | Checkpoint 5 | MicroK8s | 10% |
        | Bootnecks | InMemory Database<br>Message Queues<br>Observability<br>OAuth2<br>Payments (sandboxes) | 20% |
